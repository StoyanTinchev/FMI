...
TEST_CASE("Dictionary::isCorrectWord() returns false for a string of whitespace chars")
{
    REQUIRE_FALSE(Dictionary::isCorrectWord(" "));
    REQUIRE_FALSE(Dictionary::isCorrectWord("\t"));
    REQUIRE_FALSE(Dictionary::isCorrectWord("\n"));
...
TEST_CASE("Dictionary::erase() does not raise an error if the word is not in the dict")
{
    Dictionary dict;
    dict.insert("hello");
    dict.erase("world");
