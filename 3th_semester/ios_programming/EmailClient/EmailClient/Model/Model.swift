...
extension Folder {
    static var mocks: [Folder] {
        ...
        let inbox = Folder(name: "Inbox", icon: "tray.fill", emails: Email.getMockEmails(items: 5))
        folders.append(inbox)
        
        let importat = Folder(name: "Important", icon: "tray.fill", emails: Email.getMockEmails(items: 2))
        folders.append(importat)
        
        let trash = Folder(name: "Trash", icon: "trash.fill", emails: Email.getMockEmails(items: 5))
    ...
    mutating func deleteEmail(_ email: Email) {
